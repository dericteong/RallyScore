...
- As a player, I want to set up a match directly on a tablet so I can use PickleCast without a phone or watch.
...
- As a player on an outdoor court, I want the phone to host the tablet connection through its hotspot so PickleCast works without venue Wi-Fi or Internet.
